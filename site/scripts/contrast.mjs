...
const PAIRS = [
  ...
  ["--color-text", "--color-bg-subtle", "text", "Body copy on the subtle tint"],
  ["--color-heading", "--color-bg-subtle", "text", "Headings on the subtle tint"],
  ...
  // Action colour
  ["--color-action-text", "--color-action", "text", "Button label on action blue"],
  ["--color-action-text", "--color-action-hover", "text", "Button label on action blue (hover)"],
  ["--color-action", "--color-bg", "text", "Action blue as a link on white"],
  ["--color-action", "--color-bg", "nontext", "Action blue as border / UI boundary"],
  // Dark surfaces
  ["--color-text-inverse", "--color-bg-inverse", "text", "White on blue"],
  ["--color-text-inverse", "--color-bg-inverse-deep", "text", "White on the deepest blue"],
  ["--color-text-inverse-muted", "--color-bg-inverse", "text", "Muted on blue"],
  ["--color-text-inverse-muted", "--color-bg-inverse-deep", "text", "Muted on the deepest blue"],
  ["--logo-cyan", "--color-bg-inverse-deep", "text", "Cyan eyebrow on the deepest blue"],
  ["--logo-cyan", "--color-bg-inverse", "text", "Cyan eyebrow on blue"],
  ["--logo-cyan", "--color-bg-inverse-deep", "nontext", "Cyan strap device on the deepest blue"],
  /* Measured to EVIDENCE the restriction, not to permit it. */
  ["--logo-cyan", "--color-bg", "decorative", "Cyan on white — fails as text, fills only"],
  ["--logo-silver", "--color-bg", "decorative", "Logo silver on white — never UI text"],
  ["--logo-silver", "--color-bg-inverse-deep", "text", "Logo silver on the deepest blue"],
  ["--color-focus-inverse", "--color-bg-inverse-deep", "nontext", "Focus ring on the deepest blue"],
  ["--color-border-inverse", "--color-bg-inverse", "decorative", "Divider on blue (decorative only)"],
  ["--color-border-inverse-strong", "--color-bg-inverse", "nontext", "Input outline / meaningful boundary on blue"],
  // Status
  ["--color-error", "--color-bg", "text", "Error text on white"],
  ["--color-success", "--color-bg", "text", "Success text on white"],
  ["--color-pending", "--color-bg-subtle", "text", "Pending-verification text on the subtle tint"],
  // Known-restricted: measured so the restriction is evidenced, not asserted
  ["--color-text-inverse-muted", "--logo-blue", "text", "Muted text on an action-blue fill"],
];
